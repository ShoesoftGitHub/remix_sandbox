...
import "contracts/basics/ownable/OwnableCommented.sol";
import "contracts/basics/pollable/PollableLibraryCommented.sol";

/// @title Pollable contract
/// @author Shoesoft
/**
 * @dev The following contract has an automatic and transparent voting system.
